...
namespace Hackmum.Bethuya.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260808123745_RegistrationEventEmailUniqueness")]
    partial class RegistrationEventEmailUniqueness
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hackmum.Bethuya.Core.Models.AgendaSession", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("AssetsDueAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<string>("SpeakerAvatarUrl")
                        .HasMaxLength(2048)
                        .HasColumnType("character varying(2048)");

                    b.Property<string>("SpeakerGitHubHandle")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");

                    b.Property<string>("SpeakerTwitterHandle")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
                    ...
                    b.HasIndex("AgendaId", "Source", "SourceSessionId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Hackmum.Bethuya.Core.Models.CommunityMember", b =>
                {
                    ...
                    b.Property<bool>("ShareParticipationWithOrganizers")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Hackmum.Bethuya.Core.Models.Event", b =>
                {
                    ...
                    b.Property<string>("GitHubFolderUrl")
                        .HasMaxLength(2048)
                        .HasColumnType("character varying(2048)");
                    ...
                    b.Property<string>("SessionizeEventId")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
                    ...
                    b.Property<string>("TeamsAnnouncementMessageId")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
            ...
            modelBuilder.Entity("Hackmum.Bethuya.Core.Models.ExternalIdentity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
